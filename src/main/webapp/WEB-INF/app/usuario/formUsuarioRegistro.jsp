        ...
        <div class="modal-content">
            ...
            <form id="idFormRegistro" action="${pageContext.request.contextPath}/usuario/guardar"method="post" class="form-horizontal" data-toggle="validator">
                <div class="modal-body">
                    ...
                    <div class="form-group row"> 
                        <div class="col-sm-2">
                      <label class="control-label col-sm-2" for="codrol">Tipo Rol:</label>
                      </div>
                      <div class="col-sm-10">
                        <select id="id_codrol" name="codrol" class="form-control">
                            <option value="ADMIN" selected="">Administrador</option>
                            <option value="ASESO">Asesor</option>
                            <option value="TASAD">Tasador</option>
                        </select>  
                      </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-2">
                      <label class="control-label col-sm-2" for="correoempresa">Correo Empresa:</label>
                      </div>
                      <div required class="col-sm-10">
                        <input type="input" class="form-control" id="id_correoempresa" name="correoempresa" placeholder="Correo Empresa" value="${usuario.correoempresa}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required >
                      </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-2">
                      ...
                      <div required class="col-sm-10">
                        <input type="input" class="form-control" id="id_celular" name="celular" placeholder="Celular" value="${usuario.celular}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required >
                      </div>
                    </div>                      
                    <div class="form-group row">
                        <div class="col-sm-2">
                    ...
                    <div class="form-group row">
                          <div class="text-center">
                            <img id="id_fotousuario" src="${pageContext.request.contextPath}/archivos/download/${usuario.nombrearchivofoto}" class="img-thumbnail" alt="Foto Usuario" width="150" height="200"/>
                          </div>
                    </div> 

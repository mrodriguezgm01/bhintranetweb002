                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title" >Lista de Usuarios 
                            ...
                            <button type="button" class="btn btn-default" style="float: right;" id="idBtnEnviarCorreo">Enviar</button>
                        </h3>
                    </div>      
                    <div class="panel-body">                      
        ...
        $.ajax({
            ...
            success: function (respuesta) {
                ...
                if (flagEstadoPagina == "A") {                    
                    ...
                    $("#id_correoempresa").val(respuesta.usuario.correoempresa);
                    $("#id_celular").val(respuesta.usuario.celular);
                    $("#id_codrol").val(respuesta.usuario.codrol); 
        ...
        $.ajax({
            ...
            success: function (respuesta) {
                ...
                if (flagEstadoPagina == "E") {   
                    ...
                    $("#id_fotousuario").attr("src","${pageContext.request.contextPath}/archivos/download/"+respuesta.usuario.nombrearchivofoto);
                    $("#divModalPopupRegistroUsuarioForm").modal("show");
                }
            },
            error: function () {
...
//3. wf_guardar
  function wf_guardar() {
    ...
    var correoempresa=$("#id_correoempresa").val();    
    var codrol=$("#id_codrol").val();
    ...
    var ajax_data = {"flagEstadoPagina": flagEstadoPagina,
        ...
        "correoempresa":$.trim(correoempresa),
        "codrol":codrol
        };
...
//1. wf_editar
  function wf_subirArchivo(codusuario) {
        $("#id_flagEstadoPagina").val("");
        $("#id_flagEstadoPaginaArchivo").val("A");
...
function wf_enviarCorreo(){
    
        var ajax_data = {"id": "0"};
        $.ajax({
            url: contextPathUrl + "/usuario/envioCorreo",
            data: ajax_data,
            type: "post",
            dataType: "json",
            cache: false,
...
//======================================
    $(document).ready(function () {
        ...
        $(function () {
            ...
            $("#idBtnEnviarCorreo").on('click', function () {
                    wf_enviarCorreo();
            });
            //------------------------------
        });
